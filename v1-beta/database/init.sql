...
CREATE INDEX idx_work_tasks_asignado ON work_tasks(asignado_a_id);
CREATE INDEX idx_work_tasks_fecha_limite ON work_tasks(fecha_limite);
CREATE INDEX idx_work_appointments_asignado ON work_appointments(asignado_a_id);
CREATE INDEX idx_work_appointments_empieza ON work_appointments(empieza_en);
CREATE INDEX idx_work_notes_usuario ON work_notes(usuario_id);
CREATE INDEX idx_work_notes_fecha ON work_notes(fecha);
